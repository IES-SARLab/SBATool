function [JtileMultiPerms,indall] = tilegrowingprobG1permsExpand(tmpImg,tmpxtilevec,tmpytilevec,thresh,indg,fulltsizes)
           ...
           neg_list = [];
       	   ...
       	   while ( ( AD0>=thresh(1)  ) && ...
               ...
               if sum(ins)>0
                   ...
                   neg_list = [neg_list; ...
                               xn(:) yn(:) seqt(:) AD(:) BC(:) SR(:) AS(:) NIA(:) G3p1(:,2) G3p1(:,3) indall(seqt(:))];
               end
