function JtileMultiPerms = tilegrowingprobG3perms(tmpImg,tmpxtilevec,tmpytilevec,thresh,indg,fulltsizes)
           ...
           neg_list = [];
       	   ...
       	   while ( ( (AD0>=thresh(1))&(G3M0>thresh(5)) ) && ...
               ...
               if sum(ins)>0
                   ...
                   neg_list = [neg_list; ...
                               xn(:) yn(:) seqt(:) AD(:) BC(:) SR(:) AS(:) NIA(:) G3p3(:,2) G3p3(:,3) indg(seqt(:))];
               end
