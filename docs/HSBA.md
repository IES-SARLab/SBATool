...
| |lumberton_intp_lo_const_mean_G1A.tif<br />lumberton_intp_lo_const_mean_G1M.tif<br />lumberton_intp_lo_const_mean_G1S.tif<br />lumberton_intp_hi_const_mean_G3A.tif<br />lumberton_intp_hi_const_mean_G3M.tif<br />lumberton_intp_hi_const_mean_G3S.tif<br />(full resolution)|amplitude for the 1st Gaussian<br />mean for the 1st Gaussian<br />std for the 1st Gaussian<br />amplitude for the 3rd Gaussian<br />mean for the 3rd Gaussian<br />std for the 3rd Gaussian<br /><sub>**Note:** The values are after multiplying the actual floating values with 100 and truncating to integer</sub>|
