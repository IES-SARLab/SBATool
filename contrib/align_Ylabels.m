function align_Ylabels(figureHandle,varargin)
...
if nrows > 1
    for l = 1:ncols
        ...
        xpos = ylmaxPos(1);
        if xshift ~= 0
            set(ylmax,'Pos',[xpos+xshift ylmaxPos(2) ylmaxPos(3)]);
        end
        ...
        for k = indexes
            ...
            set(yl,'Units','pixel')
            ylPos = get(yl,'Pos');
            set(yl,'Pos',[xpos+xshift ylPos(2) ylPos(3)]);
        end
    end
end
%------------- END OF CODE --------------
